...
OUTPUT_HTML = Path(IMAGE_DIR) / "filtered" / "query_visualization.html"
    ...
    <div class="sample">
        ...
        <div class="content">
            ...
            <div class="queries">
                ...
                <div class="query"><div class="query-label">Q6: Caption Jailbreak</div><div class="query-text">{q.get('Q6_caption_adaptive_jailbreak', '')}</div></div>
            </div>
        </div>
    </div>"""
...
def main(n_samples=50, seed=42):
    ...
    print(f"Saved: {generate_html(samples, OUTPUT_HTML)}")
